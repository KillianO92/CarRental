...
class CustEditDialog(object):
    ...
    def __init__(self, parent):
        ...
        self.top = CETK.Toplevel(CustEditDialog.root)
        self.frm = CETK.Frame(self.top, borderwidth=4, relief='ridge')
...
##        self.btnReload = CETK.Button(self.frm, text='Reload Customers')
